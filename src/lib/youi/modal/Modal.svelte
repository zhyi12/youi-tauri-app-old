...
<script lang="ts">
  ...
  import { browserEvent } from '../util/utils';
  import {
  ...
  import { modalIn, modalOut } from '../util/transitions';
  ...
  <svelte:component this={outer}>
    <div class={wrapClassName} tabindex="-1" {...$$restProps}>
      {#if isOpen}
        ...
        >
          <slot name="external" />
          <div class={classes} style:max-width={width+"px"} role="document" bind:this={_dialog}>
