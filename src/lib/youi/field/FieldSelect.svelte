<script>
	...
	import ListBox from "../list-box/ListBox.svelte";
	import ListBoxField from "../list-box/ListBoxField.svelte";
	import ListBoxMenu from "../list-box/ListBoxMenu.svelte";
	import ListBoxMenuIcon from "../list-box/ListBoxMenuIcon.svelte";
	import ListBoxMenuItem from "../list-box/ListBoxMenuItem.svelte";
	import ListBoxSelection from "../list-box/ListBoxSelection.svelte";
	...
	$: filteredItems = items.filter((item) => shouldFilterItem(item, value));
	$: classes = classnames(className,'youi-field fieldSelect');
</script>
